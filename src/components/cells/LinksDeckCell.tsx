    ...
    <Card colSpan="w-full" className="flex flex-col justify-between">
      ...
      <div className="grid grid-cols-2 gap-2 mt-4">
        ...
        <a
          ...
          className="group flex flex-col items-center justify-center p-3 rounded-xl bg-neutral-50/50 dark:bg-neutral-900/30 border border-neutral-100 dark:border-neutral-900 hover:border-neutral-200 dark:hover:border-neutral-800 hover:bg-neutral-100/50 dark:hover:bg-neutral-900/60 transition-all duration-200 ease-out"
        >
          ...
          <span className="text-[10px] font-mono text-neutral-400 dark:text-neutral-500 mt-1.5">
            GitHub {/* TODO: label */}
          </span>
        </a>
