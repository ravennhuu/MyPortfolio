  ...
  return (
    <Card colSpan="w-full" className="flex flex-col justify-between">
      ...
      <div className="mt-4 sm:mt-6 space-y-4 flex-grow">
        ...
        {/* ── PROJECT 1 ── */}
        <div className="group flex flex-col justify-between p-3.5 sm:p-4 rounded-xl bg-neutral-50/50 dark:bg-neutral-900/10 border border-neutral-100 dark:border-neutral-900 hover:border-neutral-200 dark:hover:border-neutral-800 hover:bg-neutral-100/30 dark:hover:bg-neutral-900/30 active:scale-[0.99] transition-all duration-300 ease-out">
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1 min-w-0">
              <h3 className="text-sm font-semibold text-neutral-900 dark:text-neutral-100 flex items-center gap-1.5 flex-wrap">
                <span>Project Title</span>
                <span className="inline-block w-1.5 h-1.5 rounded-full bg-neutral-900 dark:bg-neutral-100 shrink-0" />
              </h3>
            ...
            <div className="flex items-center gap-2 shrink-0 pt-0.5">
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="p-1 text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors" aria-label="GitHub Repository">
              ...
              <a href="https://example.com" target="_blank" rel="noopener noreferrer" className="p-1 text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors" aria-label="Live Demo">
